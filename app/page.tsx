    ...
    <section className="hero" onPointerMove={moveAthletes} onPointerLeave={resetAthletes}>
      <header className="site-header">
        <nav className="nav shell" aria-label="เมนูหลัก">
          ...
          <div className="nav-links"><a href="#manual-therapy">การรักษา</a><a href="#exercise-rehabilitation">การฟื้นฟู</a><a href="#trehab-4t">TREHAB 4T</a><a href="#physiotherapists">ทีมของเรา</a><Link href="/articles">บทความ</Link><a href="#contact">ติดต่อ</a></div>
